...
\begin{frame}
	...
	\begin{column}{0.4\textwidth}
		\includegraphics[height=1.1\textwidth]{Illustrations/empty_stacks.PDF}
	\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.4\textwidth}
			\includegraphics[height=1.1\textwidth]{Illustrations/stack_1.PDF}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.4\textwidth}
			\includegraphics[height=1.1\textwidth]{Illustrations/stack_2.PDF}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.4\textwidth}
			\includegraphics[height=1.1\textwidth]{Illustrations/stack_3.PDF}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.4\textwidth}
			\includegraphics[height=1.1\textwidth]{Illustrations/stack_4.PDF}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.4\textwidth}
			\includegraphics[height=1.1\textwidth]{Illustrations/stack_5.PDF}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.4\textwidth}
			\includegraphics[height=1.1\textwidth]{Illustrations/stack_6.PDF}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.4\textwidth}
			\includegraphics[height=1.1\textwidth]{Illustrations/stack_7.PDF}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.4\textwidth}
			\includegraphics[height=1.1\textwidth]{Illustrations/stack_8.PDF}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.4\textwidth}
			\includegraphics[height=1.1\textwidth]{Illustrations/stack_9.PDF}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.4\textwidth}
			\includegraphics[height=1.1\textwidth]{Illustrations/stack_10.PDF}
		\end{column}
	\end{columns}
\end{frame}
