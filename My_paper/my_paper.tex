...
Here,``individuals" refers to programs. This means that variation methods are part of the actual program code so that the methods for evolution are evolving as well. \todo[inline]{is this helpful?}
