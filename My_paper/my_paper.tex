...
\todo[inline, color=green]{I might want to talk about why this is useful... why is this useful?}
...
\todo[inline, color=green]{is this (prev sentence) actually a concern? I assume it is, but maybe it's so unlikely that it's not}
