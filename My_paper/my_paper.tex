...
\end{quotation}
\todo[inline]{I say "variation" a million times... sorry guys}
Here,``individuals" refers to programs. This means that variation methods are part of the actual program code so that the methods for evolution are evolving as well. \todo[inline]{Not sure if I should describe quote here--I say this in different ways earlier in the section}
...
%FIGURE OUT HOW TO CITE NIC for previous sentence (see Notes from Sources)
