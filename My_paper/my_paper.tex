...
\todo[inline]{is there a way I can simplify this paragraph (particularly the first sentence) or reword it to be better...?}
...
\todo[inline]{I'm not actually sure abstraction is the right word here, but it sounds right...}
...
\todo[inline, color=yellow]{Clean up, more info about weird AutoDoG evolution. Include DL graphs or cut last paragraph (depending on space)}
