...
\begin{frame}
	\frametitle{Genetic Programming~--~structure for evolution}
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{.6\textwidth}
			\textit{Heuristic}~--~a function that ranks alternatives in a search algorithm at each branching step and uses that information to choose which branch to follow.
		\end{column}
		\begin{column}{.4\textwidth}
			\pause
